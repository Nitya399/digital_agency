      ...
      <div className="py-20 px-4" ref={timelineRef}>
        <div className="container mx-auto">
          ...
          <div className="relative">
            ...
            <motion.div 
              className="hidden md:block absolute left-1/2 top-0 bottom-0 w-1 bg-gray-200 transform -translate-x-1/2"
              initial={{ height: 0 }}
            ...
            <motion.div 
              className="md:hidden absolute left-8 top-0 bottom-0 w-1 bg-gray-200"
              initial={{ height: 0 }}
              animate={isTimelineInView ? { height: '100%' } : { height: 0 }}
              transition={{ duration: 1.5 }}
            />
                ...
                <div key={index} className="relative">
                  ...
                  <div className="md:hidden">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="bg-primary/10 text-primary inline-block px-3 py-1 rounded-full text-sm font-semibold mb-3">
                          {milestone.year}
                        </div>
                  ...
                  <div className={`hidden md:flex items-center ${
                    ...
                    <motion.div 
                      ...
                      transition={{ duration: 0.6, delay: index * 0.2 }}
                    >
                      <div className={`px-8 ${index % 2 === 0 ? 'text-right' : 'text-left'}`}>
                        <div className={`bg-primary/10 text-primary inline-block px-3 py-1 rounded-full text-sm font-semibold mb-3 ${
                          index % 2 === 0 ? 'ml-auto' : ''
                        }`}>
                          {milestone.year}
                    ...
                    <motion.div 
                      ...
                      transition={{ duration: 0.6, delay: index * 0.2 }}
                    >
                      <div className={`px-8 ${index % 2 === 0 ? '' : 'text-right'}`}>
                        <div className="rounded-lg overflow-hidden shadow-md">
                          <img 
                            src={milestone.image} 
                            alt={milestone.title}
